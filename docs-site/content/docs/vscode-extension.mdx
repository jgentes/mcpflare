...
Install the MCPflare extension from:
- **[VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=forgedapps.mcpflare)** - For Visual Studio Code
- **[Open VSX Registry](https://open-vsx.org/extension/forgedapps/mcpflare)** - For Cursor, VSCodium, and other Open VSX-compatible editors
