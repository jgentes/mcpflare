...
description: Deep dive into attack vectors and how MCPflare protects against them.
---
...
MCPflare creates a **zero-trust execution environment** by combining:
...
<Tabs items={['Attack', 'Protection']}>
  ...
  <Tab value="Protection">
    ...
    - ✅ Credentials stored outside isolate - All API keys managed by MCPflare server
